...
Optionally Ask the user Ask whether they'd like a brief summary of PRODUCT.md appended to PRODUCT.md for easier agent reference. If yes, append a short **Design Context** pointer section there.
