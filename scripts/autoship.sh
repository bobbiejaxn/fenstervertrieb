...
POLL_INTERVAL_SECONDS="${AUTOSHIP_POLL_INTERVAL:-300}"   # 5 minutes
...
while true; do
  ...
  # Auto-approve any spec-ready issues (no human gate)
  ...
  # Sleep in chunks so we can respect the deadline
